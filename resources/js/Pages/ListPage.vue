          ...
          <div
            ...
            <table class="min-w-full text-center">
              <thead>
                <tr>
                  <th
                    class="px-2 py-3 text-xs font-medium leading-4 tracking-wider text-gray-500 uppercase border-b border-gray-200 bg-gray-50"
              ...
              <tbody class="bg-white">
                <tr v-for="entry in columnData" :key="entry.id">
                  ...
                  <td class="px-2 py-4 whitespace-no-wrap border-b border-gray-200 max-w-min center align-middle"
                    v-for="(field, idx) in Object.keys(entry)" :key="idx">
...
export default {
  ...
  setup () {
    ...
    onMounted(async () => {
      ...
      const response = await axios.get(`/v1/${routeCategory}/columns`);
